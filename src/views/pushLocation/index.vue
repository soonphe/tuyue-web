<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row>
      ...
      <el-table-column prop="location" label="地域" align="center"></el-table-column>
...
<script>
import {pushLocationGetList, pushLocationDelete} from '@/api/server'
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      pushLocationGetList(this.listQuery)
        .then(res => {
          this.list = res.data
